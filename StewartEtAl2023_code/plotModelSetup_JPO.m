...
% Create doublearrow
annotation(figure1,'doublearrow',[0.686666666666667 0.687777777777778],...
  [0.371369294605809 0.261410788381743]);

% Create doublearrow
annotation(figure1,'doublearrow',[0.686666666666667 0.687777777777778],...
  [0.263485477178423 0.0892116182572614]);

% Create textbox
annotation(figure1,'textbox',...
  [0.696984126984127 0.299457617071725 0.0471428571428573 0.0375714285714286],...
  'String',{'h_1'},...
  'LineStyle','none',...
  'FontSize',14,...
  'FitBoxToText','off');
...
% Create textbox
annotation(figure1,'textbox',...
  [0.792539682539683 0.303606994665086 0.0471428571428573 0.0375714285714286],...
  'String',{'{\bf u}_1'},...
  'LineStyle','none',...
  'FontSize',14,...
  'FitBoxToText','off');
...
% Create textbox
annotation(figure1,'textbox',...
  [0.693650793650794 0.158378778897451 0.0471428571428573 0.0375714285714286],...
  'String',{'h_2'},...
  'LineStyle','none',...
  'FontSize',14,...
  'FitBoxToText','off');
...
% Create textbox
annotation(figure1,'textbox',...
  [0.795873015873016 0.158378778897451 0.0471428571428573 0.0375714285714286],...
  'String',{'{\bf u}_2'},...
  'LineStyle','none',...
  'FontSize',14,...
  'FitBoxToText','off');
...
% Create arrow
annotation(figure1,'arrow',[0.833 0.881111111111111],...
  [0.312904564315353 0.312904564315353],'HeadStyle','cback1','LineWidth',2);

% Create arrow
annotation(figure1,'arrow',[0.833 0.856666666666667],...
  [0.171199170124481 0.170124481327801],'HeadStyle','cback1','LineWidth',2);
