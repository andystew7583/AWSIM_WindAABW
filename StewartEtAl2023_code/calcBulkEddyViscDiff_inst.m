%%%
%%% calcBulkEddyViscDiff_inst.m
%%%
%%% Estimates bulk eddy viscosity and diffusivity from instantaneous model output.
%%%
function [kap0,nu0] = calcBulkEddyViscDiff_inst (local_home_dir,run_name)
